	...
	BEGIN
		SET @CreateTableSQLQuery = 
			'CREATE TABLE ' + @TableName + ' (
				...
				[LocalitaLocale] [varchar](16),
				[TitoloDelLavoro] [varchar](30),
				[AutoreDelLavoro] [varchar](20),
				[CodiceAutorizzazione] [varchar](2),
				[NumeroAutorizzazione] [varchar](7),
				[DataAutorizzazione] [varchar](6),
				[CodiceOpera] [varchar](11),
